...
class ResNet50CPUCheck(ResNet50BaseCheck):
    def __init__(self):
        ...
        self.descr = "ResNet50 CPU Benchmark"
        ...
        if self.current_system.name in ["archer2"]:
            ...
            self.executable_opts = ["/work/ta127/ta127/chrisrae/chris-ml-intern/ML/ResNet50/Torch/train.py"
                                    " --config", "/work/ta127/ta127/chrisrae/chris-ml-intern/ML/ResNet50/Torch/configs/archer2benchmark_config.yaml"
                                    ]
