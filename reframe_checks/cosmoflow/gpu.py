...
class CosmoFlowGPUBenchmark(CosmoFlowBaseCheck):
    ...
    executable = "python"
    executable_opts = ["/work/z043/z043/crae/chris-ml-intern/ML_HPC/CosmoFlow/Torch/train.py",
                            "--config", "/work/z043/z043/crae/chris-ml-intern/ML_HPC/CosmoFlow/Torch/configs/cirrus_config.yaml",
                            "--device", "cuda"
    ]
