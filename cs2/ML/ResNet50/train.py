...
class DummyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img, label 
        # return torch.randint(0, 255, self.shape, dtype=torch.float32) / 255.0, torch.zeros(1000).__setitem__torch.randint(0, 999, (1,)) 

def get_dummy_dataloader(params, length=2056, shape=(3,224,224)):
    import torch
    from torch.utils.data import DataLoader, Dataset
